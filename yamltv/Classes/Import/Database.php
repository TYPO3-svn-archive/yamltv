...
***************************************************************/
class tx_yamltv_import_database {
	 ...
	 * @var string
	 */
	private $sqlLocation = 'Resources/Private/Database/yamltv.sql';
	...
	public function importDatabase() {
		if (!file_exists(t3lib_extMgm::extPath('yamltv', $this->sqlLocation))) {
			return;
		}
		$fileContents = t3lib_div::getUrl(t3lib_extMgm::extPath('yamltv', $this->sqlLocation));
	...
	/**
	 * Enables or disables the realURL extension for the yamltv site
	 *
