...
abstract class tx_yamltv_view_abstract {
	/**
	...
	public function __construct() {
		...
		$this->assign(PATH_TO_RESOURCES, t3lib_div::getIndpEnv('TYPO3_SITE_PATH').t3lib_extMgm::siteRelPath('yamltv').'/Resources/Public/');
	}
	/**
