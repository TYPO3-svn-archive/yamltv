...
class tx_yamltv_view_subpackage extends tx_yamltv_view_abstract {
	 ...
	 * @var string
	 */
	protected $templateFile = 'typo3conf/ext/yamltv/Resources/Private/Templates/Installyamltv.html';
	...
	public function setSubpackage($subpackage) {
		$this->templateFile = t3lib_extMgm::siteRelPath('yamltv') . 'Resources/Private/Subpackages/' . $subpackage . '/Templates/Template.html';
	}
