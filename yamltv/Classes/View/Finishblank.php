...
class tx_yamltv_view_finishblank extends tx_yamltv_view_abstract {
	 ...
	 * @var string
	 */
	protected $templateFile = 'typo3conf/ext/yamltv/Resources/Private/Templates/Finishblank.html';
}
?>