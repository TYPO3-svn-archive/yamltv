...
***************************************************************/
require_once(t3lib_extMgm::extPath('yamltv', 'Classes/Configuration/Configuration.php'));
require_once(t3lib_extMgm::extPath('yamltv', 'Classes/Import/Database.php'));
require_once(t3lib_extMgm::extPath('yamltv', 'Classes/Import/Filestructure.php'));
require_once(t3lib_extMgm::extPath('yamltv', 'Classes/Import/Extension.php'));

class tx_yamltv_controller {
	/**
	 * The view object
	 *
	 * @var tx_yamltv_view_finish
	 */
	private $view;
	 ...
	 * @var string
	 */
	private $defaultSubpackage = 'yamltv';
	...
	public function executeStepOutput(&$markers, $step, &$callerObject) {
		$this->configuration = t3lib_div::makeInstance('tx_yamltv_configuration');
		$this->databaseImporter = t3lib_div::makeInstance('tx_yamltv_import_database');
		$this->filestructureImporter = t3lib_div::makeInstance('tx_yamltv_import_filestructure');
	...
	public function installPackageAction(&$message) {
		require_once(t3lib_extMgm::extPath('yamltv', 'Classes/View/Installyamltv.php'));
		require_once(t3lib_extMgm::extPath('yamltv', 'Classes/View/Subpackage.php'));
		...
		foreach($availableSubpackages as $subpackage) {
			$subpackageView = t3lib_div::makeInstance('tx_yamltv_view_subpackage');
		...
		$this->view = t3lib_div::makeInstance('tx_yamltv_view_installyamltv');
	...
	public function passwordAction(&$message, $displayError = false) {
		require_once(t3lib_extMgm::extPath('yamltv', 'Classes/View/Password.php'));
		$this->view = t3lib_div::makeInstance('tx_yamltv_view_password');
	...
	public function finishBlankAction(&$message) {
		require_once(t3lib_extMgm::extPath('yamltv', 'Classes/View/Finishblank.php'));
		$this->view = t3lib_div::makeInstance('tx_yamltv_view_finishblank');
	...
	public function finishAction(&$message) {
		require_once(t3lib_extMgm::extPath('yamltv', 'Classes/View/Finish.php'));
		...
		$this->view = t3lib_div::makeInstance('tx_yamltv_view_finish');
	...
	private function importNeededExtensions($subpackageToInstall) {
		$extensionImporter = t3lib_div::makeInstance('tx_yamltv_import_extension');
		$extensionImporter->setSubpackage($subpackageToInstall);

		require_once(t3lib_extMgm::extPath('yamltv', 'Resources/Private/Subpackages/' . $subpackageToInstall . '/Configuration.php'));
	...
	private function getAvailableSubpackages() {
		...
		$directories = t3lib_div::get_dirs(t3lib_extMgm::extPath('yamltv', 'Resources/Private/Subpackages'));
		foreach($directories as $directory) {
			if (file_exists(t3lib_extMgm::extPath('yamltv', 'Resources/Private/Subpackages/' . $directory . '/Configuration.php'))) {
