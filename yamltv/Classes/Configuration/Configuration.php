...
class tx_yamltv_configuration {
	...
	public function applyDefaultConfiguration() {
		$this->applyConfigurationFromFile(t3lib_extMgm::extPath('yamltv', $this->packageConfigurationPath));
	}
	...
	public function applySubpackageSpecificConfiguration($subpackage) {
		$configurationFile = t3lib_extMgm::extPath('yamltv',
